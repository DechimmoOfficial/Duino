...
const bool LED_BLINKING = false; // ради вашего удобства я сам отключил мигание светодиодом
...
const char * POOLPICKER_URL[] = {"https://ducotools.ru/getPool/"};
const char * MINER_BANNER = "Official ESP8266 Miner";
const char * MINER_VER = "3.0 modified by Dechimmo";
...
<head>
    ...
    <title>Duino-Coin @@DEVICE@@ панель управления</title>
...
<body style="background-color: #212121;">
    <section class="section" style="background-color: #212121;">
        <div class="container">
            <h1 class="title">
                <img class="icon" src="https://github.com/revoxhere/duino-coin/blob/master/Resources/duco.png?raw=true">
                <a style="color: white;">@@DEVICE@@ <small>(@@ID@@)</small></a>
            </h1>
            <p class="subtitle" style="color:white;">
                Самостоятельная, простая, официальная панель управления для вашего <strong style="color:white;">Duino-Coin</strong> майнера
            </p>
        </div>
        <br>
        <div class="container">
            <div class="columns">
                <div class="column">
                    <div class="box" style="border: 2px solid #ffa500; border-radius: 10px; background-color: #0a0a0a;">
                        <p class="subtitle" style="color:white;">
                            Статистика
                        </p>
                        <div class="columns is-multiline">
                            <div class="column" style="min-width:15em; border: 3px solid #ffa500; border-radius: 10px;">
                                <div class="heading is-size-5" style="color:white;">
                                    Хэшрейт
                                </div>
                                <div class="title is-size-5 mb-0"style="color:white;">
                                    <span id="hashratex" style="color:white;">@@HASHRATE@@</span>kH/s
                                </div>
                            </div>
                            <div class="column" style="min-width:15em; border: 3px solid #ffa500; border-radius: 10px;">
                                <div class="heading is-size-5" style="color:white;">
            ...
            <div class="has-text-centered">
                <div class="title is-size-6 mb-0"style="color:white;">
                    &bull;
                    Размещено на: @@DEVICE@@ ||
                    <a href="http://@@IP_ADDR@@">
                        http://<b>@@IP_ADDR@@</b>
